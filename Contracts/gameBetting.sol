...
contract GameCenterBetting is ChainlinkClient {
    ...
    // enum Selection {Open, Home, Away, Draw}
     enum Selection {
         Open,   //match has started & is underway
         Draw,       //anything other than a clear winner (e.g. cancelled)
         Player1, //index of participant who is the winner
         Player2,    //match was cancelled; there's no winner 
         Cancelled   
    ...
    function requestResult() public returns (bytes32 requestId)
      {
        ...
        req.add("tournamentId", game.objectId);
